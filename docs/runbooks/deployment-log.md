...
- Repo branch / commit: `agent/preserve-zoho-partial-payments` / pending merge
...
- Smoke test completed? automated repository checks pending; live Zoho smoke test required after deployment
